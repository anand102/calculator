...
btns_frame = Frame(window, width = 312, height = 272.5, bg = "lightgrey")
btns_frame.pack()

# first row
clear = Button(btns_frame, text = "C", fg = "blue", width = 32, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_clear()).grid(row = 0, column = 0, columnspan = 3, padx = 1, pady = 1)
...
equals = Button(btns_frame, text = "=", fg = "blue", width = 10, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_equal()).grid(row = 4, column = 3, padx = 1, pady = 1)
